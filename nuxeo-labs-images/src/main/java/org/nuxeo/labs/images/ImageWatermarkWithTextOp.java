 ...
 * as the picture to crop. Also, if targetFileSuffix is used, it will be added
 * to the target file name before the extension (So, if the file name is
...
public class ImageWatermarkWithTextOp {
    ...
    public Blob run(Blob inBlob) {
        ...
        // The "textWatermarking" converter is defined in OSGI-INF/extensions/conversions-contrib.xml
        Blob result = ConversionUtils.convert("textWatermarking", inBlob, params, targetFileName);
        return result;
    }
}
