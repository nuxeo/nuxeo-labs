...
/**
 * Adds a facet to the document.
 * <p>
 * IMPORTANT: This requires the document to be saved immediately.
 */
@Operation(id = AddFacet.ID, category = Constants.CAT_DOCUMENT, label = "Add Facet", description = "Adds the facet to the document. Notice: The operation saves the document.")
