...
@Operation(id = CopySchemaDM.ID, category = Constants.CAT_DOCUMENT, label = "Copy Schema From DocumentModel", description = "Copy all the info in the schema of the source to the input document.")
public class CopySchemaDM {

    public static final String ID = "Document.CopySchemaDM";
